...
import { tripayo } from "../constants/tripayo";
import { ayoReligious } from "../constants/ayoReglious";
import { hotelayo } from "../constants/hotelayo";
import { hotelNextAyo } from "../constants/hotelNextAyo";
import { ayoPark } from "../constants/ayoPark";
import { parkNextAyo } from "../constants/parkNextAyo";

function TripAyo(props) {
    return (
        <>
        <div className="trip">
